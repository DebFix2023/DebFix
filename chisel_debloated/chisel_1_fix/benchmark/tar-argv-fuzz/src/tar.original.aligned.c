...
void print_total_written(void)
{
...

  {
    ...
    {
      sprintf((char * /* __restrict  */)(bytes), (char const * /* __restrict  */) "%.0f", written);
    }
    if ((double)0 < seconds)
    {
    ...
    }
    {
      ...
      fprintf((FILE * /* __restrict  */) stderr, (char const * /* __restrict  */)tmp___4, bytes, tmp___3, tmp___2);
    }
    return;
  }
}
...
static _Bool check_label_pattern(union block *label)
{
...

  {
    ...
    }
    {
      ...
      tmp___3 = fnmatch((char const *)string, (char const *)(label->header.name), 0);
...

  {
    ...
    case_1___2: /* CIL Label */
      ...
      if (volume_label_option)
      {
        ...
        {
          {
            sprintf((char * /* __restrict  */)(record_start->header.name), (char const * /* __restrict  */) "%s Volume 1", volume_label_option);
          }
        }
        else
        {
...
void flush_write(void)
{
...

  {
    ...
    if (volume_label_option)
    {
      {
        memset((void *)record_start, 0, (size_t)512);
        sprintf((char * /* __restrict  */)(record_start->header.name), (char const * /* __restrict  */) "%s Volume %d", volume_label_option, volno);
        time_to_chars(start_timespec.tv_sec, record_start->header.mtime, sizeof(record_start->header.mtime));
        record_start->header.typeflag = (char)'V';
        finish_header(&current_stat_info, record_start, (off_t)-1);
      }
    ...
    {
      {
        ...
        memcpy((void * /* __restrict  */)current_block, (void const * /* __restrict  */)((record_start + blocking_factor) - copy_back), (size_t)(copy_back * 512));
        ...
        {
          {
            ...
            tmp___3 = ngettext("Unaligned block (%lu byte) in archive", "Unaligned block (%lu bytes) in archive", rest);
          ...
          {
            {
              ...
              tmp___4 = ngettext("Record size = %lu block", "Record size = %lu blocks", rsize);
              ...
              {
                {
                  ...
                  fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___12, tmp___11);
                }
              }
              cursor++;
            }
...
static void backspace_output(void)
{
...

  {
    ...
    {
      {
        tmp___0 = ioctl(archive, (unsigned long)(((1U << 30) | (unsigned int)(109 << 8)) | 1U) | (sizeof(struct mtop) << 16), (char *)(&operation));
        tmp___1 = tmp___0;
      }
    }
    if (tmp___1 >= 0)
    ...
    if (*tmp___2 == 5)
    {
      ...
      {
        {
          tmp___4 = ioctl(archive, (unsigned long)(((1U << 30) | (unsigned int)(109 << 8)) | 1U) | (sizeof(struct mtop) << 16), (char *)(&operation));
          tmp___5 = tmp___4;
        }
      }
      if (tmp___5 >= 0)
...
void init_volume_number(void)
{
...

  {
    ...
    {
      {
        tmp___2 = fscanf((FILE * /* __restrict  */) file, (char const * /* __restrict  */) "%d", &global_volno);
      }
      if (tmp___2 != 1)
      {
        {
          ...
          while_continue: /* CIL Label */;
            {
              ...
              fprintf((FILE * /* __restrict  */) stderr, (char const * /* __restrict  */)tmp___7, global_volno, tmp___6);
              fflush_unlocked(stderr);
              tmp___10 = fgets_unlocked((char * /* __restrict  */)(input_buffer), (int)sizeof(input_buffer), (FILE * /* __restrict  */) read_file);
            }
    ...
    {
      {
        ...
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */) "%s: ", tmp);
        __builtin_va_start(ap, fmt);
        vfprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)fmt, ap);
        __builtin_va_end(ap);
...
static int process_rawdata(size_t bytes, char *buffer___2)
{
...

  {
    ...
    if (status != bytes)
    {
      ...
      {
        {
          tmp___0 = ngettext("Could only read %lu of %lu byte", "Could only read %lu of %lu bytes", bytes);
...
void diff_archive(void)
{
...

  {
    ...
    case_50: /* CIL Label */
    {
      ...
      tmp___18 = readlink((char const * /* __restrict  */)current_stat_info.file_name, (char * /* __restrict  */)linkbuf, len + 1UL);
      status = (int)tmp___18;
    }
      if (status < 0)
      {
      ...
      else
      {
        ...
        {
          {
            tmp___21 = strncmp((char const *)current_stat_info.link_name, (char const *)linkbuf, len);
          }
          if (tmp___21 != 0)
          {
            {
...
void verify_volume(void)
{
...

  {
    ...
    {
      {
        tmp___6 = ioctl(archive, (unsigned long)(((1U << 30) | (unsigned int)(109 << 8)) | 1U) | (sizeof(struct mtop) << 16), (char *)(&operation));
        status = tmp___6;
      }
    }
    if (status < 0)
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if ((unsigned int)status___0 == 5U)
        {
          ...
          {
            tmp___8 = ngettext("VERIFY FAILURE: %d invalid header detected", "VERIFY FAILURE: %d invalid headers detected", (unsigned long)counter);
        ...
        _L___3: /* CIL Label */
          ...
          if (substitute)
          {
            ...
            }
            {
              ...
              error(0, 0, (char const *)tmp___6, value_string, type, minval_string, maxval_string, sub_string);
  ...
  {
    {
      ...
      strncpy((char * /* __restrict  */)(header->header.magic), (char const * /* __restrict  */) "ustar", (size_t)6);
      strncpy((char * /* __restrict  */)(header->header.version), (char const * /* __restrict  */) "00", (size_t)2);
    }
    return (header);
  }
}
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          memcpy((void * /* __restrict  */)(header->buffer), (void const * /* __restrict  */)p, bufsize);
          p += bufsize;
          size -= bufsize;
    ...
    {
      memcpy((void * /* __restrict  */)(header->buffer), (void const * /* __restrict  */)p, size);
...
static union block *write_ustar_long_name(char const *name)
{
...

  {
    ...
    }
    {
      ...
      memcpy((void * /* __restrict  */)(header->header.prefix), (void const * /* __restrict  */)name, i);
      memcpy((void * /* __restrict  */)(header->header.name), (void const * /* __restrict  */)((name + i) + 1), (length - i) - 1UL);
    }
    return (header);
  }
}
...
static union block *write_extended(struct tar_stat_info *st, union block *old_header)
{
...

  {
    ...
    }
    {
      ...
      memcpy((void * /* __restrict  */)(hp.buffer), (void const * /* __restrict  */)old_header, sizeof(hp));
      p = xheader_xhdr_name(st);
      xheader_write((char)'x', p, &extended_header);
      free((void *)p);
      header = find_next_block();
      memcpy((void * /* __restrict  */)header, (void const * /* __restrict  */)(&hp.buffer), sizeof(hp.buffer));
    }
    return (header);
  }
}
...
void simple_finish_header(union block *header)
{
  ...
  {
    {
      memcpy((void * /* __restrict  */)(header->header.chksum), (void const * /* __restrict  */) "        ", sizeof(header->header.chksum));
      sum = 0;
      p = header->buffer;
      i = sizeof(*header);
    }
        ...
        {
          {
            ...
            tmp___2 = ngettext("%s: File shrank by %s byte; padding with zeros", "%s: File shrank by %s bytes; padding with zeros", (unsigned long)size_left);
        ...
        if (gnu_list_name->dir_contents)
        {
          ...
          }
          {
            ...
            while_continue___0: /* CIL Label */;
              ...
              {
                memcpy((void * /* __restrict  */)(blk->buffer), (void const * /* __restrict  */)p_buffer, bufsize);
      ...
      }
      {
        ...
        while_continue___0: /* CIL Label */;
          ...
          if (!tmp___6)
          {
            ...
            {
              memcpy((void * /* __restrict  */)buffer___2, (void const * /* __restrict  */)p, plen);
            }
          ...
          else
          {
            if ((st->stat.st_mode & 61440U) == 40960U)
            {
              ...
              }
              {
                ...
                tmp___14 = readlink((char const * /* __restrict  */)p, (char * /* __restrict  */)buffer___2, linklen + 1UL);
                size = (int)tmp___14;
              }
              if (size < 0)
              {
  ...
  {
    {
      ...
      memcpy((void * /* __restrict  */)((new_record + new_blocks)->buffer), (void const * /* __restrict  */)(data + blocks * 512UL), rest);
    }
    if (rest < 512UL)
    {
      {
...

  {
    ...
    else
    {
      ...
      _L___3: /* CIL Label */
        ...
        {
          {
            memcpy((void * /* __restrict  */)new_record, (void const * /* __restrict  */)record_start, (size_t)(new_blocks * 512));
          }
        }
        if ((unsigned int)logical_status == 1U)
        {
          ...
          while_continue___0: /* CIL Label */;
            ...
            }
            {
              ...
              while_continue___2: /* CIL Label */;
                ...
                {
                  memcpy((void * /* __restrict  */)(new_record + new_blocks), (void const * /* __restrict  */)current_block, (size_t)(count * 512));
                  new_blocks += count;
                  current_block += count;
          ...
          if (data->file_name_len < file_name_len)
          {
            if (*(file_name + data->file_name_len))
            {
              ...
              else
              {
                ...
                _L___3: /* CIL Label */
                {
                  tmp___0 = memcmp((void const *)file_name, (void const *)(data->file_name), data->file_name_len);
                }
                  if (tmp___0 == 0)
                  {
                    goto while_break;
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (h)
                  {
                    ...
                    {
                      {
                        tmp___19 = strncmp((char const *)file_name, (char const *)(h->file_name), h->file_name_len);
                      }
                      if (tmp___19 == 0)
                      {
                              ...
                              while_continue___1: /* CIL Label */;
                                {
                                  ...
                                  tmp___18 = stat((char const * /* __restrict  */)(h->file_name), (struct stat * /* __restrict  */)(&st));
                                }
                                if (tmp___18 != 0)
                                {
                                  {
      ...
      {
        {
          ...
          fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___44, tmp___43);
        }
      }
      goto switch_break;
    case_78: /* CIL Label */
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          memcpy((void * /* __restrict  */)(header->buffer), (void const * /* __restrict  */)p, len);
        }
        if (len < 512UL)
        {
          {
...
static _Bool decode_record(char **p, void (*handler)(void *, char const *, char const *), void *data)
{
...

  {
    ...
    {
      len = strtoul((char const * /* __restrict  */) * p, (char ** /* __restrict  */)p, 10);
    }
    if ((int)*(*p) != 32)
    {
      {
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          memcpy((void * /* __restrict  */)(extended_header.buffer + j), (void const * /* __restrict  */)(p->buffer), len);
...
static void xheader_print(struct xheader *xhdr, char const *keyword, char const *value)
{
...

  {
    ...
    {
      memcpy((void * /* __restrict  */)__o->next_free, (void const * /* __restrict  */)(nbuf), (size_t)__len);
      __o->next_free += __len;
      __o___0 = xhdr->stk;
    }
    ...
    {
      memcpy((void * /* __restrict  */)__o___1->next_free, (void const * /* __restrict  */)keyword, (size_t)__len___0);
    ...
    {
      memcpy((void * /* __restrict  */)__o___3->next_free, (void const * /* __restrict  */)value, (size_t)__len___1);
...
static void scan_path(struct obstack *stk, char *path, dev_t device)
{
...

  {
      ...
      if ((unsigned int)children != 0U)
      {
        entry = (char const *)dirp;
        {
          ...
          while_continue: /* CIL Label */;
            ...
            {
              memcpy((void * /* __restrict  */)__o___4->next_free, (void const * /* __restrict  */)entry, (size_t)__len);
    ...
    {
      memcpy((void * /* __restrict  */)__o___5->next_free, (void const * /* __restrict  */) "\000\000", (size_t)__len___0);
...
void read_directory_file(void)
{
...

  {
    ...
    }
    {
      ...
      tmp___22 = getline((char ** /* __restrict  */)(&buf), (size_t * /* __restrict  */)(&bufsize), (FILE * /* __restrict  */) fp);
    }
    if (0L < tmp___22)
    {
      {
        ...
        tmp = __errno_location();
        *tmp = 0;
        tmp___0 = strtoul((char const * /* __restrict  */)buf, (char ** /* __restrict  */)(&ebuf), 10);
        u = tmp___0;
        t = (time_t)u;
      }
      ...
      }
      {
        ...
        while_continue: /* CIL Label */;
          {
            tmp___21 = getline((char ** /* __restrict  */)(&buf), (size_t * /* __restrict  */)(&bufsize), (FILE * /* __restrict  */) fp);
            n = (int)tmp___21;
          }
          if (!(0 < n))
          {
          ...
          }
          {
            ...
            *tmp___7 = 0;
            u = strtoul((char const * /* __restrict  */)strp, (char ** /* __restrict  */)(&ebuf), 10);
            dev = u;
          }
...
static _Bool write_directory_file_entry(void *entry, void *data)
{
...

  {
    ...
    if (directory->found)
    {
      ...
      {
        fprintf((FILE * /* __restrict  */) fp, (char const * /* __restrict  */)("+%lu %lu %s\n" + !directory->nfs), (unsigned long)directory->device_number, (unsigned long)directory->inode_number, tmp___4);
        tmp___0 = __errno_location();
        e = *tmp___0;
      }
      if (str)
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          memcpy((void * /* __restrict  */)to, (void const * /* __restrict  */)(data_block->buffer), copied);
          to += copied;
              ...
              {
                {
                  ...
                  fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___6, program_name, tmp___5);
                }
              }
              {
          ...
          {
            {
              ...
              fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___5, tmp___4);
            }
          }
          {
            set_next_block_after(current_header);
          ...
          {
            {
              ...
              fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___11, tmp___10);
            }
          }
          goto switch_break;
        case_5: /* CIL Label */
            ...
            {
              {
                ...
                fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___15, tmp___14);
              }
            }
            {
        ...
        size = current_stat_info.stat.st_size;
        {
          ...
          while_continue: /* CIL Label */;
            ...
            }
            {
              tmp___0 = __errno_location();
              *tmp___0 = 0;
              check = fwrite_unlocked((void const * /* __restrict  */)(data_block->buffer), sizeof(char), written, (FILE * /* __restrict  */) stdlis);
              set_next_block_after((union block *)((data_block->buffer + written) - 1));
            }
            if (check != written)
            {
                    ...
                    _L___3: /* CIL Label */
                      ...
                      }
                      {
                        ...
                        while_continue___2: /* CIL Label */;
                          ...
                          {
                            memcpy((void * /* __restrict  */)bp, (void const * /* __restrict  */)(data_block->buffer), written);
                            bp += written;
                            set_next_block_after((union block *)((data_block->buffer + written) - 1));
                            size -= written;
                          }
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (h->prefix[0])
                  {
                    ...
                    {
                      {
                        memcpy((void * /* __restrict  */)np, (void const * /* __restrict  */)(h->prefix), sizeof(h->prefix));
                  ...
                  {
                    memcpy((void * /* __restrict  */)np, (void const * /* __restrict  */)(h->name), sizeof(h->name));
                ...
                {
                  {
                    memcpy((void * /* __restrict  */)(namebuf), (void const * /* __restrict  */)(h->linkname), sizeof(h->linkname));
                ...
                {
                  {
                    ...
                    error(0, 0, (char const *)tmp___2, (int)(where - where1), where1, type);
                    negative = 1;
                  }
                }
              }
              ...
              {
                {
                  ...
                  string = (char *)tmp___6;
                  memcpy((void * /* __restrict  */)string, (void const * /* __restrict  */)where0, digs);
...
char const *tartime(time_t t)
{
...

  {
    ...
    {
      {
        sprintf((char * /* __restrict  */)(buffer), (char const * /* __restrict  */) "%04ld-%02d-%02d %02d:%02d:%02d", (long)tm->tm_year + 1900L, tm->tm_mon + 1, tm->tm_mday, tm->tm_hour, tm->tm_min, tm->tm_sec);
      }
...

  {
    ...
    if (block_number_option)
    {
      ...
      }
      {
        ...
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___0, tmp);
      }
    }
    if (verbose_option <= 1)
    {
    ...
    else
    {
        ...
        {
          {
            ...
            sprintf((char * /* __restrict  */)(uform), (char const * /* __restrict  */) "%ld", (long)tmp___5);
            user = uform;
          }
        }
      }
        ...
        {
          {
            ...
            sprintf((char * /* __restrict  */)(gform), (char const * /* __restrict  */) "%ld", (long)tmp___7);
            group = gform;
          }
        }
      }
      ...
      {
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */) "%s %s/%s %*s%s %s", modes, user, group, ugswidth - pad, "", size, time_stamp);
        tmp___16 = quotearg((char const *)temp_name);
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */) " %s", tmp___16);
      }
      {
        if ((int)current_header->header.typeflag == 50)
        {
      ...
      case_49___0: /* CIL Label */
      {
        ...
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___19, tmp___18);
      }
        goto switch_break___1;
      switch_default___0: /* CIL Label */
      {
        ...
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___21, tmp___20);
      }
        goto switch_break___1;
      case_0___0:  /* CIL Label */
      ...
      case_77___0: /* CIL Label */
      {
        ...
        fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___27, size);
      }
        goto switch_break___1;
      ...
      {
        {
          ...
          fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___1, tmp___0);
        }
      }
      {
    ...
    *(buffer___2 + size) = (char)'\000';
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          memcpy((void * /* __restrict  */)copy, (void const * /* __restrict  */)(block->buffer), available);
          copy += available;
          ...
          {
            {
              ...
              memcpy((void * /* __restrict  */)buffer___2, (void const * /* __restrict  */)string, length);
      ...
      {
        {
          ...
          fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___4, tmp___3, tmp___2);
        }
      }
      return ((_Bool)1);
    }
      ...
      {
        {
          ...
          fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */)tmp___6, tmp___5, tmp___4);
        }
      }
      {
        assign_string(&after_backup_name, (char const *)0);
  ...
  {
    {
      ...
      tmp___2 = ngettext("%s: Read error at byte %s, reading %lu byte", "%s: Read error at byte %s, reading %lu bytes", size);
  ...
  {
    {
      ...
      tmp___0 = stringify_uintmax_t_backwards((uintmax_t)offset, buf + ((((sizeof(uintmax_t) * 8UL) * 302UL) / 1000UL + 1UL) + 1UL));
      tmp___1 = quotearg_colon(name);
      tmp___2 = ngettext("%s: Warning: Read error at byte %s, reading %lu byte", "%s: Warning: Read error at byte %s, reading %lu bytes", size);
      error(0, e, (char const *)tmp___2, tmp___1, tmp___0, size);
    }
    return;
  }
...
void write_error_details(char const *name, size_t status, size_t size)
{
...

  {
    ...
    {
      {
        tmp = ngettext("%s: Wrote only %lu of %lu byte", "%s: Wrote only %lu of %lu bytes", size);
...
char *new_name(char const *path, char const *name)
{
...

  {
    ...
    }
    {
      ...
      buffer___2 = (char *)tmp___1;
      memcpy((void * /* __restrict  */)buffer___2, (void const * /* __restrict  */)path, pathlen);
      *(buffer___2 + pathlen) = (char)'/';
      memcpy((void * /* __restrict  */)((buffer___2 + pathlen) + slash), (void const * /* __restrict  */)name, namesize);
    }
    return (buffer___2);
  }
}
      ...
      {
        {
          ...
          prefix = (char *)tmp___0;
          memcpy((void * /* __restrict  */)prefix, (void const * /* __restrict  */)file_name, prefix_len);
...

  {
    ...
    if (status == 0)
    {
      ...
      if (remote_user)
      {
        ...
        {
          execl(remote_shell, remote_shell_basename, remote_host, "-l", remote_user, tmp___15, (char *)0);
        }
      }
      else
      {
    ...
    size_left = ((file->stat_info)->sparse_map + i)->numbytes;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        }
        {
          ...
          tmp___3 = memcmp((void const *)(blk->buffer), (void const *)(diff_buffer___0), rdsize);
        }
        if (tmp___3)
        {
          {
...
int confirm(char const *message_action, char const *message_name)
{
...

  {
    ...
    }
    {
      ...
      fprintf((FILE * /* __restrict  */) stdlis, (char const * /* __restrict  */) "%s %s?", message_action, tmp);
      fflush_unlocked(stdlis);
    }
    if (confirm_file_EOF)
    {
      ...
      {
        {
          ...
          tmp___64 = ngettext("%s: Volume label is too long (limit is %lu byte)", "%s: Volume label is too long (limit is %lu bytes)", volume_label_max_len);
          ...
          {
            {
              ...
              tmp___4 = ngettext("%s: File shrank by %s byte", "%s: File shrank by %s bytes", (unsigned long)bytes_left);
        ...
        if (!tmp___1)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                {
                  tmp = memcmp((void const *)(vallist + valsize * (size_t)matchind), (void const *)(vallist + valsize * (size_t)i), valsize);
                }
                if (tmp)
                {
                  ambiguous = 1;
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          {
            tmp___0 = memcmp((void const *)last_val, (void const *)(vallist + valsize * (size_t)i), valsize);
          }
          if (tmp___0)
          {
            {
          ...
          {
            {
              fprintf((FILE * /* __restrict  */) stderr, (char const * /* __restrict  */) ", `%s\'", *(arglist + i));
            }
          }
        }
        i++;
          ...
          {
            {
              ...
              sprintf((char * /* __restrict  */)numbered_suffix, (char const * /* __restrict  */) ".~%d~", highest_backup + 1);
  ...
  {
    {
      ...
      memcpy((void * /* __restrict  */)newpath, (void const * /* __restrict  */)path, length);
    }
    if (append_dot)
    {
      tmp___1 = length;
  ...
  {
    {
      ...
      i = numberlen;
      memcpy((void * /* __restrict  */)(buf), (void const * /* __restrict  */)number, numberlen);
      d = number + numberlen;
    }
    {
      while (1)
      ...
      while_continue: /* CIL Label */;
        ...
        }
        {
          d -= grouplen;
          i -= grouplen;
          memcpy((void * /* __restrict  */)d, (void const * /* __restrict  */)(buf + i), grouplen);
        }
        if (i == 0UL)
        {
          return (d);
...

  {
    ...
    {
      {
        ...
        sprintf((char * /* __restrict  */)buf, (char const * /* __restrict  */) "%.0Lf", tmp___2);
    ...
    else
    {
      ...
      }
      {
        ...
        sprintf((char * /* __restrict  */)buf, (char const * /* __restrict  */) "%.1Lf", tmp___3);
        buflen = strlen((char const *)buf);
      ...
      {
        {
          ...
          sprintf((char * /* __restrict  */)buf, (char const * /* __restrict  */) "%.0Lf", tmp___4 / (long double)10);
          buflen = strlen((char const *)buf);
          nonintegerlen = (size_t)0;
        }
      }
          ...
          if (amt < 10UL)
          {
            ...
            else
            {
              ...
              _L___3: /* CIL Label */
              {
                ...
                *p = (char)(48 + tenths);
                p -= decimal_pointlen;
                memcpy((void * /* __restrict  */)p, (void const * /* __restrict  */)decimal_point, decimal_pointlen);
                rounding = 0;
                tenths = rounding;
              }
              }
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if ((int const) * (entry + tmp___8) != 0)
        {
          ...
          {
            memcpy((void * /* __restrict  */)(name_space + used), (void const * /* __restrict  */)entry, entry_size);
            used += entry_size;
          }
        }
      }
...
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base, unsigned long *val, char const *valid_suffixes)
{
...

  {
    ...
    if (0 <= strtol_base)
    {
      ...
      {
        {
          __assert_fail("0 <= strtol_base && strtol_base <= 36", "/home/wslee/project/cbenchmarks/tar-1.14/lib/xstrtol.c", 117U, "xstrtoul");
        }
      }
    }
    else
...
strtol_error xstrtoumax(char const *s, char **ptr, int strtol_base, uintmax_t *val, char const *valid_suffixes)
{
...

  {
    ...
    if (0 <= strtol_base)
    {
      ...
      {
        {
          __assert_fail("0 <= strtol_base && strtol_base <= 36", "/home/wslee/project/cbenchmarks/tar-1.14/lib/xstrtol.c", 117U, "xstrtoumax");
        }
      }
    }
    else
