...
static _Bool link_count_optimize_ok(FTSENT const *p)
{
  ...
  struct hash_table *tmp___0;
  {
    ...
    {
      tmp___0 = hash_initialize((size_t)13, (Hash_tuning const *)((void *)0), &LCO_hash, &LCO_compare, (void (*)(void *))(&free));
...
void usage(int status)
{
  ...
  char *tmp___10;
  {
    ...
    else
    {
      ...
      tmp___1 = gettext("Change the owner and/or group of each FILE to OWNER and/or "
      ...
      tmp___6 = gettext("The following options modify how a hierarchy is traversed when the "
...
int main(int argc, char **argv)
{
  ...
  int tmp___15;
  {
    ...
    case_neg_130:
      ...
      goto switch_break;
    case_neg_131:
      version_etc(stdout, "chown", "GNU coreutils", Version, "David MacKenzie", "Jim Meyering", (char *)((void *)0));
      exit(0);
      goto switch_break;
    switch_default:
      usage(1);
