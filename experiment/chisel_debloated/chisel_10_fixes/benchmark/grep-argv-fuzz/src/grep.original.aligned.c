  ...
  char *__cil_tmp45;
  {
    ...
    if ((unsigned long)cp == (unsigned long)((void *)0))
    {
      ...
      if ((unsigned long)file_name___1 != (unsigned long)((void *)0))
      {
        ...
        {
          memcpy((void * /* __restrict  */)((void *)((file_name___1 + dir_len___0) + add_slash)), (void const * /* __restrict  */)((void const *)base), base_len___0 + 1UL);
        }
      }
      if ((unsigned long)file_name___1 == (unsigned long)((void *)0))
      {
          ...
          else
          {
            ...
            res_size = (size_t)0;
            {
              ...
              while_continue: /* CIL Label */;
                ...
                {
                  strcpy((char * /* __restrict  */)(((res_ptr + res_size) - (l2 + 1UL)) - (l1 + 1UL)), (char const * /* __restrict  */)((char const *)(buf1)));
    ...
    else
    {
      ...
      _L:
      {
        ...
        if (tmp___3)
        {
          ...
          {
            {
              tmp___2 = lstat((char const * /* __restrict  */)((char const *)p->fts_accpath), (struct stat * /* __restrict  */) sbp);
            }
            if (tmp___2 == 0)
            {
              {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        _L___0:
          ...
          {
            {
              copyset((charclass_word * /* const  */)(*(d->charclasses + (*(d->tokens + pos.index) - 275L))), matches);
            }
          }
          else
          {
    ...
    i = -128;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        }
        {
          ...
          mbs.__count = 0;
          mbs.__value.__wch = 0U;
          mbclen_cache[uc] = mbrlen((char const * /* __restrict  */)((char const *)(&c)), (size_t)1, (mbstate_t * /* __restrict  */)(&mbs));
          i++;
        }
      }
    while_break___0: /* CIL Label */;
    ...
    if (is_dir)
    {
      ...
      else
      {
        ...
        _L:
          ...
          {
            {
              tmp = excluded_file_name((struct exclude const *)excluded_directory_patterns, name);
            }
            if (tmp)
            {
              tmp___0 = 1;
