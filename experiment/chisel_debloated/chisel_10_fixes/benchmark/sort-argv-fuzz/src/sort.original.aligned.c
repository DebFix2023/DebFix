...
static void readisaac(struct isaac *isaac, unsigned char *p, size_t size)
{
  ...
  isaac_word *wp;
  {
    ...
    while (1)
    {
      if (size <= inbytes)
      {
        memcpy((void *)p, (void const *)((isaac->data.b + (unsigned long)(1 << 8) * sizeof(isaac_word)) - inbytes), size);
        isaac->buffered = inbytes - size;
        return;
      }
      memcpy((void *)p, (void const *)((isaac->data.b + (unsigned long)(1 << 8) * sizeof(isaac_word)) - inbytes), inbytes);
      p += inbytes;
      size -= inbytes;
      wp = (isaac_word *)p;
      while (1)
  ...
  size_t left_over___0;
  {
    if (ctx->buflen != 0U)
    {
      ...
      if (ctx->buflen > 64U)
      {
        ...
        ctx->buflen &= 63U;
        memcpy((void *)(ctx->buffer), (void const *)((char *)(ctx->buffer) + ((left_over + add) & 0xffffffffffffffc0UL)), (size_t)ctx->buflen);
      }
  ...
  int tmp___3;
  {
    ...
    if ((unsigned long)cp == (unsigned long)((void *)0))
    {
      ...
      if ((unsigned long)file_name___3 != (unsigned long)((void *)0))
      {
        ...
        memcpy((void *)((file_name___3 + dir_len___0) + add_slash), (void const *)base, base_len___0 + 1UL);
      }
      if ((unsigned long)file_name___3 == (unsigned long)((void *)0))
      {
        cp = "";
    ...
    if (hard_LC_COLLATE)
    {
      ...
      while (1)
      {
        ...
        if (!xfrm_diff)
        {
          ...
          xfrm_diff = memcmp((void const *)buf___1, (void const *)(buf___1 + sizea), tmp___7);
          if (!xfrm_diff)
          {
        ...
        else
        {
          ...
          _L___2:
            ...
            _L___1:
              ...
              tmp___22 = ngettext("option \'-%s\' is ignored", "options \'-%s\' are ignored", tmp___21);
